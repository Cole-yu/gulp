...
function move(e){		
	...
	//e.targetTouches[0].pageX获取到的是事件触发源在文档中的水平像素,dX是以rem为单位的值，需要除以当前文档的字体大小fontSizePx(此变量在wap.js中赋值)
	dX=(e.targetTouches[0].pageX-wid)/fontSizePx-5;
	dY=(e.targetTouches[0].pageY-hei)/fontSizePx-8.2;
	console.log(dX,dY);	

	// if(isIOS){// pageX为文档中的位置，clientX为浏览器窗口位置，screenX为显示屏的位置,在滚动页页面时添加scrollX
	// 	//iphone SE fontSize:85.333px
	// 	if(screen.width==320&&screen.height==568){			
	// 		dX=(e.targetTouches[0].pageX-wid)/100-4.2;
	// 		dY=(e.targetTouches[0].pageY-hei)/100-6.9;
	// 		console.log("iphone SE plus:"+dX,dY);
	// 		// document.getElementById("dashboard").innerHTML="iphone SE<br>dX:"+dX+"<br>dY:"+dY;
	// 	}
	// 	//iphone 6/7/8 PLUS fontSize:165.6px
	// 	if(screen.width==414&&screen.height==736){		
	// 		// dX=(e.targetTouches[0].pageX-wid)/100-8.6;
	// 		// dY=(e.targetTouches[0].pageY-hei)/100-14;
	// 		dX=(e.targetTouches[0].pageX-wid)/fontSizePx-5;
	// 		dY=(e.targetTouches[0].pageY-hei)/fontSizePx-8.2;

	// 		console.log("iphone 8 plus:"+dX,dY);
	// 		// document.getElementById("dashboard").innerHTML="iphone 6/7/8 PLUS<br>dX:"+dX+"<br>dY:"+dY;			
	// 	}
	// 	//iphone 6/7/8 fontSize:100px
	// 	if(screen.width==375&&screen.height==667){			
	// 		dX=(e.targetTouches[0].pageX-wid)/fontSizePx-5;
	// 		dY=(e.targetTouches[0].pageY-hei)/fontSizePx-8.2;
	// 		console.log(dX,dY);
	// 		// document.getElementById("dashboard").innerHTML="iphone 6/7/8<br>dX:"+dX+"<br>dY:"+dY;
	// 	}
	...
	// 		dY=(e.targetTouches[0].pageY-hei)/100-6.9;
	// 	}
	// 	// document.getElementById("dashboard").innerHTML="安卓<br>dX:"+dX+"<br>dY:"+dY;
	// }		
...
function bootstrap(){	
	var jump=setInterval(function(){
			$("#hand").fadeIn(650).fadeOut(900);
		},1550);

	$("#bootControl").click(function(){		
		clearInterval(jump);
		$("#bootstrap").fadeOut(500);
		startTime();
